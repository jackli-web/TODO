<template>
  <div class="box">
    ...
    <div class="detail">
      ...
      <!-- <div class="bookname">{{self.bookName}}</div> -->
      ...
      <div class="imgbox">
        <van-swipe @change="onChange" :autoplay="3000" indicator-color="white">
          ...
          <van-swipe-item><img class="img1" :src="self.imgUrl" alt="" srcset=""></van-swipe-item>
          <van-swipe-item><img class="img1" :src="self.imgUrl" alt="" srcset=""></van-swipe-item>
          <van-swipe-item><img class="img1" :src="self.imgUrl" alt="" srcset=""></van-swipe-item>
        </van-swipe>
      </div>
      ...
      <div>
        ...
        <div class="pri">
          <div class="otherprice1 c" v-for="(item,index) in self.otherPrice" :key="index">
            <!-- <div>kindle</div>
            <div>$8.03</div> -->
...
export default {
  ...
  methods: {
    ...
    addtoca(){
      var obj={...this.self,count:this.count}
